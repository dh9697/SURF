...
export function ContentComponent() {
  return (
    <>
      <button>play</button>
      컨텐트 제목을 누르든 버튼을 누르든 이 화면으로 이동함 모달로 "강의 시청이
      완료되었습니다 <br /> 과제를 바로 푸실? (y / n) n - 기존 페이지로 이동, y
      - 과제 페이지로 이동" y/n 둘 다 상세페이지에는 수강 듣기에서 수강 완료로
      변경 과제 페이지는 커리큘럼에 나와 있는 과제와 연결해서 진행 - 완료되면
      상세페이지에서 완료로 변경
    </>
  );
}
